## stylish theme for Gedit editor
This theme provides styles for HTML, CSS, DIFF, INI, JAVA, JS, JSON, MD, PERL, PHP, PYTHON, RUBY, SH, XML, C.  

### Installation  
Copy the [`stylish.xml`](/extra/gedit/stylish.xml) file to the color schemes directory:  
...
### Activation
  ...
  3. Select `stylish Gedit` from the "Color Scheme" list
  4. Enjoy
